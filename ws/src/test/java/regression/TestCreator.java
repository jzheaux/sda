...
public class TestCreator {
    ...
    public void testCreator() {
        ...
        Regression.putCacheContent(CacheKeys.CURRENT_USER, u1);
        ...
        Regression.putCacheContent(CacheKeys.DESIGN_MATRIX_DOUBLE, doubleX1);
        Regression.putCacheContent(CacheKeys.RESPONSE_MATRIX_DOUBLE, doubleY1);
        TwoPartyBinomialLogitRegressionCreatorHandler h = new TwoPartyBinomialLogitRegressionCreatorHandler();
        h.creatorStartRegression();
    }
}